...
#FUCK THE CHICKEN chicken_Exp <- read_delim("Chicken_rpkm.txt")
...
Human_to_all <- True_expression %>%
  mutate(ensembl_mm_gene_id = ifelse(!is.na(ensembl_gene_id), ensembl_gene_id, ensembl_mm_gene_id),
         ensembl_md_gene_id = ifelse(!is.na(ensembl_gene_id), ensembl_gene_id, ensembl_md_gene_id),
  )
...
All_organism_data <- Human_to_all %>% 
  dplyr::select(-c("external_gene_name.x", "mmusculus_homolog_ensembl_gene", "mmusculus_homolog_associated_gene_name", 
                   "external_gene_name.y", "mmulatta_homolog_ensembl_gene", "mmulatta_homolog_associated_gene_name", 
                   "external_gene_name", "mdomestica_homolog_ensembl_gene", "mdomestica_homolog_associated_gene_name"))
